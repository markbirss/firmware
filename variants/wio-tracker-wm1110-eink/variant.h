...
//#define BUTTON_PIN_SECONDARY (32 + 2) // P1.02 
...
static const uint8_t SS = (32 + 12); // P1.12 // NSS
...
#define PIN_SPI1_MOSI (0 + 15) // EPD_MOSI
#define PIN_SPI1_SCK (0 + 13)  // EPD_SCLK

/*
 * eink display pins
 */

//#define USE_EINK //not used with InkHUD
#define PIN_EINK_CS (0 + 31)   // EPD_CS
#define PIN_EINK_BUSY (0 + 14) // EPD_BUSY
#define PIN_EINK_DC (0 + 16)   // EPD_D/C
#define PIN_EINK_RES (0 + 30)  // EPD_RESET
